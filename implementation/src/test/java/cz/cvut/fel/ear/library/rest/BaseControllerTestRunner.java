...
import cz.cvut.fel.ear.library.environment.Environment;
import cz.cvut.fel.ear.library.rest.handler.RestExceptionHandler;
...
import static cz.cvut.fel.ear.library.environment.Environment.createDefaultMessageConverter;
import static cz.cvut.fel.ear.library.environment.Environment.createStringEncodingMessageConverter;
    ...
    public void setUp(Object controller) {
        ...
        this.mockMvc = MockMvcBuilders.standaloneSetup(controller).setControllerAdvice(new RestExceptionHandler())
                .setMessageConverters(createDefaultMessageConverter(),
                        createStringEncodingMessageConverter()).setUseSuffixPatternMatch(false)
                .build();
    }
